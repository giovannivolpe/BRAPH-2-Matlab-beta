classdef AnalyzeGroup_CON_FUN_MP_GA_WU < AnalyzeGroup
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('AnalyzeGroup_CON_FUN_MP_GA_WU', [], [], true);
		end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(AnalyzeGroup_CON_FUN_MP_GA_WU.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == AnalyzeGroup_CON_FUN_MP_GA_WU.getProps());
		...
		function check_out = existsTag(tag)
			...
			analyzegroup_con_fun_mp_ga_wu_tag_list = cellfun(@(x) AnalyzeGroup_CON_FUN_MP_GA_WU.getPropTag(x), num2cell(AnalyzeGroup_CON_FUN_MP_GA_WU.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, analyzegroup_con_fun_mp_ga_wu_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				analyzegroup_con_fun_mp_ga_wu_tag_list = cellfun(@(x) AnalyzeGroup_CON_FUN_MP_GA_WU.getPropTag(x), num2cell(AnalyzeGroup_CON_FUN_MP_GA_WU.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, analyzegroup_con_fun_mp_ga_wu_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN
						tag = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN_TAG;
					case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX
						tag = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN
					prop_category = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN_CATEGORY;
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX
					prop_category = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX_CATEGORY;
				case AnalyzeGroup_CON_FUN_MP_GA_WU.CORRELATION_RULE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN
					prop_format = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN_FORMAT;
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX
					prop_format = AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX_FORMAT;
				case AnalyzeGroup_CON_FUN_MP_GA_WU.CORRELATION_RULE
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_CON_FUN_MP_GA_WU.NAME
					prop_description = 'NAME (constant, string) is the name of the graph analysis with connectivity and functional multiplex data.';
				case AnalyzeGroup_CON_FUN_MP_GA_WU.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the graph analysis with connectivity and functional multiplex data.';
				case AnalyzeGroup_CON_FUN_MP_GA_WU.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the graph analysis with connectivity and functional multiplex data.';
				case AnalyzeGroup_CON_FUN_MP_GA_WU.ID
					prop_description = 'ID (data, string) is a few-letter code for the graph analysis with connectivity and functional multiplex data.';
				case AnalyzeGroup_CON_FUN_MP_GA_WU.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the graph analysis with connectivity and functional multiplex data.';
				case AnalyzeGroup_CON_FUN_MP_GA_WU.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the graph analysis with connectivity and functional multiplex data.';
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case AnalyzeGroup_CON_FUN_MP_GA_WU.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.ID
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:AnalyzeGroup_CON_FUN_MP_GA_WU:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case AnalyzeGroup_CON_FUN_MP_GA_WU.REPETITION % __AnalyzeGroup_CON_FUN_MP_GA_WU.REPETITION__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN % __AnalyzeGroup_CON_FUN_MP_GA_WU.F_MIN__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX % __AnalyzeGroup_CON_FUN_MP_GA_WU.F_MAX__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.CORRELATION_RULE % __AnalyzeGroup_CON_FUN_MP_GA_WU.CORRELATION_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.NEGATIVE_WEIGHT_RULE % __AnalyzeGroup_CON_FUN_MP_GA_WU.NEGATIVE_WEIGHT_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.TEMPLATE % __AnalyzeGroup_CON_FUN_MP_GA_WU.TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				case AnalyzeGroup_CON_FUN_MP_GA_WU.G % __AnalyzeGroup_CON_FUN_MP_GA_WU.G__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeGroup_CON_FUN_MP_GA_WU.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(a, prop, varargin)
			...
			switch prop
				case AnalyzeGroup_CON_FUN_MP_GA_WU.G % __AnalyzeGroup_CON_FUN_MP_GA_WU.G__
					rng_settings_ = rng(); rng(a.getPropSeed(AnalyzeGroup_CON_FUN_MP_GA_WU.G), 'twister')
