classdef ImporterGroupSubjectST_MP_XLS < Importer
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('ImporterGroupSubjectST_MP_XLS', [], [], true);
		end
		function prop_list = getProps(category)
			...
			if nargin == 0
				prop_list = [ ...
					Importer.getProps() ...
						ImporterGroupSubjectST_MP_XLS.DIRECTORY ...
						ImporterGroupSubjectST_MP_XLS.GET_DIR ...
						ImporterGroupSubjectST_MP_XLS.BA ...
						ImporterGroupSubjectST_MP_XLS.GR ...
						];
				return
			end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(ImporterGroupSubjectST_MP_XLS.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == ImporterGroupSubjectST_MP_XLS.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':ImporterGroupSubjectST_MP_XLS:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':ImporterGroupSubjectST_MP_XLS:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			importergroupsubjectst_mp_xls_tag_list = cellfun(@(x) ImporterGroupSubjectST_MP_XLS.getPropTag(x), num2cell(ImporterGroupSubjectST_MP_XLS.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, importergroupsubjectst_mp_xls_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				importergroupsubjectst_mp_xls_tag_list = cellfun(@(x) ImporterGroupSubjectST_MP_XLS.getPropTag(x), num2cell(ImporterGroupSubjectST_MP_XLS.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, importergroupsubjectst_mp_xls_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ImporterGroupSubjectST_MP_XLS.DIRECTORY
						tag = ImporterGroupSubjectST_MP_XLS.DIRECTORY_TAG;
					case ImporterGroupSubjectST_MP_XLS.GET_DIR
						tag = ImporterGroupSubjectST_MP_XLS.GET_DIR_TAG;
					case ImporterGroupSubjectST_MP_XLS.BA
						tag = ImporterGroupSubjectST_MP_XLS.BA_TAG;
					case ImporterGroupSubjectST_MP_XLS.GR
						tag = ImporterGroupSubjectST_MP_XLS.GR_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ImporterGroupSubjectST_MP_XLS.DIRECTORY
					prop_category = ImporterGroupSubjectST_MP_XLS.DIRECTORY_CATEGORY;
				case ImporterGroupSubjectST_MP_XLS.GET_DIR
					prop_category = ImporterGroupSubjectST_MP_XLS.GET_DIR_CATEGORY;
				case ImporterGroupSubjectST_MP_XLS.BA
					prop_category = ImporterGroupSubjectST_MP_XLS.BA_CATEGORY;
				case ImporterGroupSubjectST_MP_XLS.GR
					prop_category = ImporterGroupSubjectST_MP_XLS.GR_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ImporterGroupSubjectST_MP_XLS.DIRECTORY
					prop_format = ImporterGroupSubjectST_MP_XLS.DIRECTORY_FORMAT;
				case ImporterGroupSubjectST_MP_XLS.GET_DIR
					prop_format = ImporterGroupSubjectST_MP_XLS.GET_DIR_FORMAT;
				case ImporterGroupSubjectST_MP_XLS.BA
					prop_format = ImporterGroupSubjectST_MP_XLS.BA_FORMAT;
				case ImporterGroupSubjectST_MP_XLS.GR
					prop_format = ImporterGroupSubjectST_MP_XLS.GR_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case ImporterGroupSubjectST_MP_XLS.GET_DIR
					prop_description = 'GET_DIR (query, item) opens a dialog box to set the directory from where to load the XLS/XLSX files of the ST MP subject group with L layers.';
				case ImporterGroupSubjectST_MP_XLS.BA
				...
				case ImporterGroupSubjectST_MP_XLS.NAME
					prop_description = 'NAME (constant, string) is the name of the ST MP subject group importer from XLS/XLSX.';
				case ImporterGroupSubjectST_MP_XLS.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the ST MP subject group importer from XLS/XLSX.';
				case ImporterGroupSubjectST_MP_XLS.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the ST MP subject group importer from XLS/XLSX.';
				case ImporterGroupSubjectST_MP_XLS.ID
					prop_description = 'ID (data, string) is a few-letter code for the ST MP subject group importer from XLS/XLSX.';
				case ImporterGroupSubjectST_MP_XLS.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the ST MP subject group importer from XLS/XLSX.';
				case ImporterGroupSubjectST_MP_XLS.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the ST MP subject group importer from XLS/XLSX.';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case ImporterGroupSubjectST_MP_XLS.GET_DIR
					prop_default = Format.getFormatDefault(Format.ITEM, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.BA
					prop_default = Format.getFormatDefault(Format.ITEM, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.GR
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:ImporterGroupSubjectST_MP_XLS:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case ImporterGroupSubjectST_MP_XLS.DIRECTORY % __ImporterGroupSubjectST_MP_XLS.DIRECTORY__
					check = Format.checkFormat(Format.STRING, value, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.GET_DIR % __ImporterGroupSubjectST_MP_XLS.GET_DIR__
					check = Format.checkFormat(Format.ITEM, value, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.BA % __ImporterGroupSubjectST_MP_XLS.BA__
					check = Format.checkFormat(Format.ITEM, value, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.GR % __ImporterGroupSubjectST_MP_XLS.GR__
					check = Format.checkFormat(Format.ITEM, value, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				case ImporterGroupSubjectST_MP_XLS.TEMPLATE % __ImporterGroupSubjectST_MP_XLS.TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, ImporterGroupSubjectST_MP_XLS.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(im, prop, varargin)
			...
			switch prop
				...
				case ImporterGroupSubjectST_MP_XLS.GR % __ImporterGroupSubjectST_MP_XLS.GR__
					rng_settings_ = rng(); rng(im.getPropSeed(ImporterGroupSubjectST_MP_XLS.GR), 'twister')
