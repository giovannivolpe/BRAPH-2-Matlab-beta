classdef NNDataPoint_FUN_CLA < NNDataPoint
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of a data point for classification with functional data.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of a data point for classification with functional data.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of a data point for classification with functional data.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for a data point for classification with functional data.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of a data point for classification with functional data.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about a data point for classification with functional data.
	...
	%  <strong>9</strong> <strong>SUB</strong> 	SUB (data, item) is a subject with functional data.
	%  <strong>10</strong> <strong>TARGET_IDS</strong> 	TARGET_IDS (parameter, stringlist) is a list of variable-of-interest IDs to be used as classification targets.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nndatapoint_fun_cla_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'INPUT'  'TARGET'  'SUB'  'TARGET_IDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_fun_cla_category_list = { 1  1  3  4  2  2  5  5  4  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nndatapoint_fun_cla_format_list = { 2  2  8  2  2  2  16  16  8  3 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 9 % NNDataPoint_FUN_CLA.SUB
					prop_settings = 'SubjectFUN';
				case 10 % NNDataPoint_FUN_CLA.TARGET_IDS
					prop_settings = Format.getFormatSettings(3);
				case 3 % NNDataPoint_FUN_CLA.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % NNDataPoint_FUN_CLA.NAME
					prop_default = 'NNDataPoint_FUN_CLA';
				case 2 % NNDataPoint_FUN_CLA.DESCRIPTION
				...
				case 3 % NNDataPoint_FUN_CLA.TEMPLATE
					prop_default = Format.getFormatDefault(8, NNDataPoint_FUN_CLA.getPropSettings(prop));
				case 4 % NNDataPoint_FUN_CLA.ID
					prop_default = 'NNDataPoint_FUN_CLA ID';
				case 5 % NNDataPoint_FUN_CLA.LABEL
					prop_default = 'NNDataPoint_FUN_CLA label';
				case 6 % NNDataPoint_FUN_CLA.NOTES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(dp, prop, varargin)
			...
			switch prop
				case 7 % NNDataPoint_FUN_CLA.INPUT
				...
				case 8 % NNDataPoint_FUN_CLA.TARGET
