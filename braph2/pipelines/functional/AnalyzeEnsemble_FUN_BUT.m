classdef AnalyzeEnsemble_FUN_BUT < AnalyzeEnsemble
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('AnalyzeEnsemble_FUN_BUT', [], [], true);
		end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(AnalyzeEnsemble_FUN_BUT.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == AnalyzeEnsemble_FUN_BUT.getProps());
		...
		function check_out = existsTag(tag)
			...
			analyzeensemble_fun_but_tag_list = cellfun(@(x) AnalyzeEnsemble_FUN_BUT.getPropTag(x), num2cell(AnalyzeEnsemble_FUN_BUT.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, analyzeensemble_fun_but_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				analyzeensemble_fun_but_tag_list = cellfun(@(x) AnalyzeEnsemble_FUN_BUT.getPropTag(x), num2cell(AnalyzeEnsemble_FUN_BUT.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, analyzeensemble_fun_but_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeEnsemble_FUN_BUT.F_MIN
						tag = AnalyzeEnsemble_FUN_BUT.F_MIN_TAG;
					case AnalyzeEnsemble_FUN_BUT.F_MAX
						tag = AnalyzeEnsemble_FUN_BUT.F_MAX_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUT.F_MIN
					prop_category = AnalyzeEnsemble_FUN_BUT.F_MIN_CATEGORY;
				case AnalyzeEnsemble_FUN_BUT.F_MAX
					prop_category = AnalyzeEnsemble_FUN_BUT.F_MAX_CATEGORY;
				case AnalyzeEnsemble_FUN_BUT.CORRELATION_RULE
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUT.F_MIN
					prop_format = AnalyzeEnsemble_FUN_BUT.F_MIN_FORMAT;
				case AnalyzeEnsemble_FUN_BUT.F_MAX
					prop_format = AnalyzeEnsemble_FUN_BUT.F_MAX_FORMAT;
				case AnalyzeEnsemble_FUN_BUT.CORRELATION_RULE
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUT.NAME
					prop_description = 'NAME (constant, string) is the name of the ensemble-based graph analysis with functional data of fixed threshold.';
				case AnalyzeEnsemble_FUN_BUT.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with functional data of fixed threshold.';
				case AnalyzeEnsemble_FUN_BUT.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with functional data of fixed threshold.';
				case AnalyzeEnsemble_FUN_BUT.ID
					prop_description = 'ID (data, string) is a few-letter code for the ensemble-based graph analysis with functional data of fixed threshold.';
				case AnalyzeEnsemble_FUN_BUT.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with functional data of fixed threshold.';
				case AnalyzeEnsemble_FUN_BUT.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with functional data of fixed threshold.';
				...
				case AnalyzeEnsemble_FUN_BUT.GRAPH_TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUT.GRAPH_TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.G_DICT
					prop_default = Format.getFormatDefault(Format.IDICT, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:AnalyzeEnsemble_FUN_BUT:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUT.REPETITION % __AnalyzeEnsemble_FUN_BUT.REPETITION__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.F_MIN % __AnalyzeEnsemble_FUN_BUT.F_MIN__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.F_MAX % __AnalyzeEnsemble_FUN_BUT.F_MAX__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.CORRELATION_RULE % __AnalyzeEnsemble_FUN_BUT.CORRELATION_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.NEGATIVE_WEIGHT_RULE % __AnalyzeEnsemble_FUN_BUT.NEGATIVE_WEIGHT_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.THRESHOLDS % __AnalyzeEnsemble_FUN_BUT.THRESHOLDS__
					check = Format.checkFormat(Format.RVECTOR, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.GRAPH_TEMPLATE % __AnalyzeEnsemble_FUN_BUT.GRAPH_TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeEnsemble_FUN_BUT.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUT.G_DICT % __AnalyzeEnsemble_FUN_BUT.G_DICT__
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(a, prop, varargin)
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUT.G_DICT % __AnalyzeEnsemble_FUN_BUT.G_DICT__
					rng_settings_ = rng(); rng(a.getPropSeed(AnalyzeEnsemble_FUN_BUT.G_DICT), 'twister')
