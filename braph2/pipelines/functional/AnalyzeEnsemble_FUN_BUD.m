classdef AnalyzeEnsemble_FUN_BUD < AnalyzeEnsemble
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('AnalyzeEnsemble_FUN_BUD', [], [], true);
		end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(AnalyzeEnsemble_FUN_BUD.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == AnalyzeEnsemble_FUN_BUD.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':AnalyzeEnsemble_FUN_BUD:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			analyzeensemble_fun_bud_tag_list = cellfun(@(x) AnalyzeEnsemble_FUN_BUD.getPropTag(x), num2cell(AnalyzeEnsemble_FUN_BUD.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, analyzeensemble_fun_bud_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				analyzeensemble_fun_bud_tag_list = cellfun(@(x) AnalyzeEnsemble_FUN_BUD.getPropTag(x), num2cell(AnalyzeEnsemble_FUN_BUD.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, analyzeensemble_fun_bud_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case AnalyzeEnsemble_FUN_BUD.REPETITION
						tag = AnalyzeEnsemble_FUN_BUD.REPETITION_TAG;
					case AnalyzeEnsemble_FUN_BUD.F_MIN
						tag = AnalyzeEnsemble_FUN_BUD.F_MIN_TAG;
					case AnalyzeEnsemble_FUN_BUD.F_MAX
						tag = AnalyzeEnsemble_FUN_BUD.F_MAX_TAG;
					case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
						tag = AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE_TAG;
					case AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE
						tag = AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE_TAG;
					case AnalyzeEnsemble_FUN_BUD.DENSITIES
						tag = AnalyzeEnsemble_FUN_BUD.DENSITIES_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUD.REPETITION
					prop_category = AnalyzeEnsemble_FUN_BUD.REPETITION_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.F_MIN
					prop_category = AnalyzeEnsemble_FUN_BUD.F_MIN_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.F_MAX
					prop_category = AnalyzeEnsemble_FUN_BUD.F_MAX_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
					prop_category = AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE
					prop_category = AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE_CATEGORY;
				case AnalyzeEnsemble_FUN_BUD.DENSITIES
					prop_category = AnalyzeEnsemble_FUN_BUD.DENSITIES_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUD.REPETITION
					prop_format = AnalyzeEnsemble_FUN_BUD.REPETITION_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.F_MIN
					prop_format = AnalyzeEnsemble_FUN_BUD.F_MIN_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.F_MAX
					prop_format = AnalyzeEnsemble_FUN_BUD.F_MAX_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE
					prop_format = AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE
					prop_format = AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE_FORMAT;
				case AnalyzeEnsemble_FUN_BUD.DENSITIES
					prop_format = AnalyzeEnsemble_FUN_BUD.DENSITIES_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUD.NAME
					prop_description = 'NAME (constant, string) is the name of the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.ID
					prop_description = 'ID (data, string) is a few-letter code for the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with functional data of fixed density.';
				case AnalyzeEnsemble_FUN_BUD.GR
					prop_description = 'GR (data, item) is the subject group, which also defines the subject class SubjectFUN.';
				case AnalyzeEnsemble_FUN_BUD.GRAPH_TEMPLATE
					prop_description = 'GRAPH_TEMPLATE (parameter, item) is the graph template to set all graph and measure parameters.';
				case AnalyzeEnsemble_FUN_BUD.G_DICT
					prop_description = 'G_DICT (result, idict) is the graph (MultigraphBUD) ensemble obtained from this analysis.';
				case AnalyzeEnsemble_FUN_BUD.ME_DICT
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemble_FUN_BUD.GRAPH_TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.G_DICT
					prop_default = Format.getFormatDefault(Format.IDICT, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:AnalyzeEnsemble_FUN_BUD:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUD.REPETITION % __AnalyzeEnsemble_FUN_BUD.REPETITION__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.F_MIN % __AnalyzeEnsemble_FUN_BUD.F_MIN__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.F_MAX % __AnalyzeEnsemble_FUN_BUD.F_MAX__
					check = Format.checkFormat(Format.SCALAR, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE % __AnalyzeEnsemble_FUN_BUD.CORRELATION_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE % __AnalyzeEnsemble_FUN_BUD.NEGATIVE_WEIGHT_RULE__
					check = Format.checkFormat(Format.OPTION, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.DENSITIES % __AnalyzeEnsemble_FUN_BUD.DENSITIES__
					check = Format.checkFormat(Format.RVECTOR, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.GRAPH_TEMPLATE % __AnalyzeEnsemble_FUN_BUD.GRAPH_TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				case AnalyzeEnsemble_FUN_BUD.G_DICT % __AnalyzeEnsemble_FUN_BUD.G_DICT__
					check = Format.checkFormat(Format.IDICT, value, AnalyzeEnsemble_FUN_BUD.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(a, prop, varargin)
			...
			switch prop
				case AnalyzeEnsemble_FUN_BUD.G_DICT % __AnalyzeEnsemble_FUN_BUD.G_DICT__
					rng_settings_ = rng(); rng(a.getPropSeed(AnalyzeEnsemble_FUN_BUD.G_DICT), 'twister')
