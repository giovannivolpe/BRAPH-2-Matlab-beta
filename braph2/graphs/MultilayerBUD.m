classdef MultilayerBUD < MultilayerWU
	%MultilayerBUD is a multilayer binary undirected with fixed densities graph.
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case MultilayerBUD.NAME
					prop_description = 'NAME (constant, string) is the name of the binary undirected multilayer with fixed densities.';
				case MultilayerBUD.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the binary undirected multilayer with fixed densities.';
				case MultilayerBUD.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the binary undirected multilayer with fixed densities.';
				case MultilayerBUD.ID
					prop_description = 'ID (data, string) is a few-letter code for the binary undirected multilayer with fixed densities.';
				...
				case MultilayerBUD.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the binary undirected multilayer with fixed densities.';
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				...
				case MultilayerBUD.SUBGRAPH % __MultilayerBUD.SUBGRAPH__
					B = g.get('B');
					L = g.get('LAYERNUMBER');
					if isempty(varargin)
					    value = g;
					...
					value = MultilayerBUD('B', BB, 'TEMPLATE', g, ...
