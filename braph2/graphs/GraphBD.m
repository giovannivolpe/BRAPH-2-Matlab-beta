classdef GraphBD < Graph
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the binary directed graph.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the binary directed graph.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the binary directed graph.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the binary directed graph.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the binary directed graph.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the binary directed graph.
	%  <strong>7</strong> <strong>GRAPH_TYPE</strong> 	GRAPH_TYPE (constant, scalar) returns the graph type Graph.GRAPH.
	%  <strong>8</strong> <strong>CONNECTIVITY_TYPE</strong> 	CONNECTIVITY_TYPE (query, smatrix) returns the connectivity type Graph.BINARY.
	%  <strong>9</strong> <strong>DIRECTIONALITY_TYPE</strong> 	DIRECTIONALITY_TYPE (query, smatrix) returns the directionality type Graph.DIRECTED.
	...
	%  <strong>20</strong> <strong>A</strong> 	A (result, cell) is the binary adjacency matrix of the binary directed graph.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				graphbd_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'GRAPH_TYPE'  'CONNECTIVITY_TYPE'  'DIRECTIONALITY_TYPE'  'SELFCONNECTIVITY_TYPE'  'NEGATIVITY_TYPE'  'LAYERTICKS'  'ALAYERTICKS'  'LAYERLABELS'  'ALAYERLABELS'  'NODELABELS'  'ANODELABELS'  'RANDOMIZE'  'RANDOM_SEED'  'A'  'A_CHECK'  'NODENUMBER'  'LAYERNUMBER'  'PARTITIONS'  'M_DICT'  'COMPATIBLE_MEASURES'  'MEASURE'  'PFGA'  'PFGH'  'B'  'SEMIPOSITIVIZE_RULE'  'ATTEMPTSPEREDGE'  'RANDOMIZATION' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			graphbd_category_list = { 1  1  3  4  2  2  1  6  6  6  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			graphbd_format_list = { 2  2  8  2  2  2  11  15  15  15  11  12  12  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  15  5  11  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 31 % GraphBD.SEMIPOSITIVIZE_RULE
					prop_settings = {'zero', 'absolute'};
				case 32 % GraphBD.ATTEMPTSPEREDGE
					prop_settings = Format.getFormatSettings(11);
				case 33 % GraphBD.RANDOMIZATION
					prop_settings = Format.getFormatSettings(16);
				case 3 % GraphBD.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 5 % GraphBD.LABEL
					prop_default = 'GraphBD label';
				case 6 % GraphBD.NOTES
					prop_default = 'GraphBD notes';
				case 7 % GraphBD.GRAPH_TYPE
					prop_default = 1;
				case 26 % GraphBD.COMPATIBLE_MEASURES
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				...
				case 8 % GraphBD.CONNECTIVITY_TYPE
					value = 2;
					
				case 9 % GraphBD.DIRECTIONALITY_TYPE
					value = 1;
					
				case 10 % GraphBD.SELFCONNECTIVITY_TYPE
					value = 1;
					
				case 11 % GraphBD.NEGATIVITY_TYPE
					value = 1;
