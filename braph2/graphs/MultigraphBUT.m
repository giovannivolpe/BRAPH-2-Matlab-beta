classdef MultigraphBUT < GraphWU
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the binary undirected multigraph with fixed thresholds.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the binary undirected multigraph with fixed thresholds.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the binary undirected multigraph with fixed thresholds.
	%  <strong>4</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code for the binary undirected multigraph with fixed thresholds.
	%  <strong>5</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the binary undirected multigraph with fixed thresholds.
	%  <strong>6</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the binary undirected multigraph with fixed thresholds.
	%  <strong>7</strong> <strong>GRAPH_TYPE</strong> 	GRAPH_TYPE (constant, scalar) returns the graph type Graph.MULTIGRAPH.
	...
	%  <strong>24</strong> <strong>PARTITIONS</strong> 	PARTITIONS (result, rvector) returns the number of layers (1) for each partition (threshold) of the graph.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				multigraphbut_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'GRAPH_TYPE'  'CONNECTIVITY_TYPE'  'DIRECTIONALITY_TYPE'  'SELFCONNECTIVITY_TYPE'  'NEGATIVITY_TYPE'  'LAYERTICKS'  'ALAYERTICKS'  'LAYERLABELS'  'ALAYERLABELS'  'NODELABELS'  'ANODELABELS'  'RANDOMIZE'  'RANDOM_SEED'  'A'  'A_CHECK'  'NODENUMBER'  'LAYERNUMBER'  'PARTITIONS'  'M_DICT'  'COMPATIBLE_MEASURES'  'MEASURE'  'PFGA'  'PFGH'  'B'  'SYMMETRIZE_RULE'  'SEMIPOSITIVIZE_RULE'  'STANDARDIZE_RULE'  'ATTEMPTSPEREDGE'  'NUMBEROFWEIGHTS'  'RANDOMIZATION'  'THRESHOLDS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multigraphbut_category_list = { 1  1  3  4  2  2  1  6  6  6  6  2  6  2  6  2  6  3  3  5  6  5  5  5  5  1  6  9  9  4  3  3  3  3  3  6  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multigraphbut_format_list = { 2  2  8  2  2  2  11  15  15  15  11  12  12  3  3  3  3  4  11  16  4  12  11  12  10  7  8  8  8  15  5  5  5  11  11  16  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 37 % MultigraphBUT.THRESHOLDS
					prop_settings = Format.getFormatSettings(12);
				case 3 % MultigraphBUT.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 1 % MultigraphBUT.NAME
					prop_default = 'MultigraphBUT';
				case 2 % MultigraphBUT.DESCRIPTION
				...
				case 4 % MultigraphBUT.ID
					prop_default = 'MultigraphBUT ID';
				case 5 % MultigraphBUT.LABEL
					prop_default = 'MultigraphBUT label';
				case 6 % MultigraphBUT.NOTES
					prop_default = 'MultigraphBUT notes';
				case 7 % MultigraphBUT.GRAPH_TYPE
					prop_default = 2;
				case 26 % MultigraphBUT.COMPATIBLE_MEASURES
				...
				case 34 % MultigraphBUT.ATTEMPTSPEREDGE
					prop_default = 5;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(g, prop, varargin)
			...
			switch prop
				case 8 % MultigraphBUT.CONNECTIVITY_TYPE
					if isempty(varargin)
					    layernumber = 1;
					else
				...
				case 9 % MultigraphBUT.DIRECTIONALITY_TYPE
					if isempty(varargin)
					    layernumber = 1;
					else
					    layernumber = varargin{1};
				...
				case 10 % MultigraphBUT.SELFCONNECTIVITY_TYPE
					if isempty(varargin)
					    layernumber = 1;
					else
					    layernumber = varargin{1};
				...
				case 11 % MultigraphBUT.NEGATIVITY_TYPE
					if isempty(varargin)
					    layernumber = 1;
					else
					    layernumber = varargin{1};
				...
				case 24 % MultigraphBUT.PARTITIONS
				...
				case 15 % MultigraphBUT.ALAYERLABELS
				...
				case 36 % MultigraphBUT.RANDOMIZATION
