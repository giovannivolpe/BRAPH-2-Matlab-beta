	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case ComparisonEnsemble.PFBG
						tag = ComparisonEnsemble.PFBG_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case ComparisonEnsemble.PFBG
					prop_category = ComparisonEnsemble.PFBG_CATEGORY;
				case ComparisonEnsemble.CALCULATE_RESULTS
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case ComparisonEnsemble.PFBG
					prop_format = ComparisonEnsemble.PFBG_FORMAT;
				case ComparisonEnsemble.CALCULATE_RESULTS
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case ComparisonEnsemble.PFC % __ComparisonEnsemble.PFC__
					check = Format.checkFormat(Format.ITEM, value, ComparisonEnsemble.getPropSettings(prop));
				case ComparisonEnsemble.PFBG % __ComparisonEnsemble.PFBG__
					check = Format.checkFormat(Format.ITEM, value, ComparisonEnsemble.getPropSettings(prop));
