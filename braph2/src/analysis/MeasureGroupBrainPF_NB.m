classdef MeasureGroupBrainPF_NB < MeasureGroupBrainPF
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_nb_category_list = { 1  1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  8  7  7  7  8  8  7  8  2  7  8  8  8  2  7  8  8  7  8  8  7  8  8  7  8  8  8  8  2  8  8  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			measuregroupbrainpf_nb_format_list = { 2  2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  8  18  19  18  12  8  18  5  8  18  4  8  8  8  19  4  10  19  4  10  19  4  10  19  4  10  5  5  8  2  2  1 };
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pf, prop, varargin)
			...
			switch prop
				case 51 % MeasureGroupBrainPF_NB.SETUP
					m = pf.get('M');
					% update spheres
					% size
					ax_ = pf.get('H_AXES');
