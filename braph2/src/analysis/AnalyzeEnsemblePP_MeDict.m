classdef AnalyzeEnsemblePP_MeDict < PanelProp
	...
	properties (Constant) % properties
		...
		GUI_G_PL = PanelProp.getPropNumber() + 5;
		GUI_G_PL_TAG = 'GUI_G_PL';
		GUI_G_PL_CATEGORY = Category.GUI;
		GUI_G_PL_FORMAT = Format.ITEM;
		
		GUI_G_EL = PanelProp.getPropNumber() + 6;
		GUI_G_EL_TAG = 'GUI_G_EL';
		GUI_G_EL_CATEGORY = Category.GUI;
		GUI_G_EL_FORMAT = Format.ITEM;
		
		GUI_F_DICT = PanelProp.getPropNumber() + 7;
		GUI_F_DICT_TAG = 'GUI_F_DICT';
		GUI_F_DICT_CATEGORY = Category.GUI;
		GUI_F_DICT_FORMAT = Format.IDICT;
		
		GUI_M_DICT = PanelProp.getPropNumber() + 8;
	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					PanelProp.getProps() ...
						...
						AnalyzeEnsemblePP_MeDict.GUI_G_PL ...
						AnalyzeEnsemblePP_MeDict.GUI_G_EL ...
						AnalyzeEnsemblePP_MeDict.GUI_F_DICT ...
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case AnalyzeEnsemblePP_MeDict.GUI_G_PL
						tag = AnalyzeEnsemblePP_MeDict.GUI_G_PL_TAG;
					case AnalyzeEnsemblePP_MeDict.GUI_G_EL
						tag = AnalyzeEnsemblePP_MeDict.GUI_G_EL_TAG;
					case AnalyzeEnsemblePP_MeDict.GUI_F_DICT
						tag = AnalyzeEnsemblePP_MeDict.GUI_F_DICT_TAG;
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemblePP_MeDict.GUI_G_PL
					prop_category = AnalyzeEnsemblePP_MeDict.GUI_G_PL_CATEGORY;
				case AnalyzeEnsemblePP_MeDict.GUI_G_EL
					prop_category = AnalyzeEnsemblePP_MeDict.GUI_G_EL_CATEGORY;
				case AnalyzeEnsemblePP_MeDict.GUI_F_DICT
					prop_category = AnalyzeEnsemblePP_MeDict.GUI_F_DICT_CATEGORY;
				case AnalyzeEnsemblePP_MeDict.GUI_M_DICT
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemblePP_MeDict.GUI_G_PL
					prop_format = AnalyzeEnsemblePP_MeDict.GUI_G_PL_FORMAT;
				case AnalyzeEnsemblePP_MeDict.GUI_G_EL
					prop_format = AnalyzeEnsemblePP_MeDict.GUI_G_EL_FORMAT;
				case AnalyzeEnsemblePP_MeDict.GUI_F_DICT
					prop_format = AnalyzeEnsemblePP_MeDict.GUI_F_DICT_FORMAT;
				case AnalyzeEnsemblePP_MeDict.GUI_M_DICT
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case AnalyzeEnsemblePP_MeDict.GUI_G_PL
					prop_description = 'GUI_G_PL (gui, item) contains the GUI for the graph figure.';
				case AnalyzeEnsemblePP_MeDict.GUI_G_EL
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case AnalyzeEnsemblePP_MeDict.CONTEXTMENU % __AnalyzeEnsemblePP_MeDict.CONTEXTMENU__
					check = Format.checkFormat(Format.HANDLE, value, AnalyzeEnsemblePP_MeDict.getPropSettings(prop));
				case AnalyzeEnsemblePP_MeDict.GUI_G_PL % __AnalyzeEnsemblePP_MeDict.GUI_G_PL__
				...
				case AnalyzeEnsemblePP_MeDict.GUI_G_EL % __AnalyzeEnsemblePP_MeDict.GUI_G_EL__
					check = Format.checkFormat(Format.ITEM, value, AnalyzeEnsemblePP_MeDict.getPropSettings(prop));
				case AnalyzeEnsemblePP_MeDict.GUI_F_DICT % __AnalyzeEnsemblePP_MeDict.GUI_F_DICT__
