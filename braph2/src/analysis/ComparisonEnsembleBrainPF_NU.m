classdef ComparisonEnsembleBrainPF_NU < ComparisonEnsembleBrainPF
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case ComparisonEnsembleBrainPF_NU.LAYER
					prop_description = 'LAYER (figure, scalar) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.SIZE_DIFF
					prop_description = 'SIZE_DIFF (figure, option) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.SIZE_SCALE
					prop_description = 'SIZE_SCALE (figure, scalar) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.COLOR_DIFF
					prop_description = 'COLOR_DIFF (figure, option) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.FDR
					prop_description = 'FDR (figure, option) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.QVALUE
					prop_description = 'QVALUE (figure, scalar) is the node number of the nodal measure.';
				case ComparisonEnsembleBrainPF_NU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the panel figure nodal unilayer ensemble-based comparison figure on brain surface.';
