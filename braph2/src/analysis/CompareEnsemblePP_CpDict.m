	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				compareensemblepp_cpdict_tag_list = { 'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'WAITBAR'  'H_WAITBAR'  'DRAW'  'DRAWN'  'PARENT'  'BKGCOLOR'  'H'  'SHOW'  'HIDE'  'DELETE'  'CLOSE'  'X_DRAW'  'UPDATE'  'REDRAW'  'EL'  'PROP'  'HEIGHT'  'TITLE'  'LABEL_TITLE'  'BUTTON_CB'  'GUI_CB'  'LISTENER_CB'  'BUTTON_CALC'  'BUTTON_DEL'  'LISTENER_SET'  'LISTENER_MEMORIZED'  'LISTENER_LOCKED'  'TABLE_HEIGHT'  'SELECTED'  'TABLE'  'CONTEXTMENU'  'GUI_F_DICT'  'GUI_CP_DICT'  'GUI_BG_DICT' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			compareensemblepp_cpdict_category_list = { 1  1  3  4  2  2  6  9  7  6  6  9  8  7  6  6  6  6  6  6  6  4  4  9  9  7  7  4  7  7  7  7  7  7  9  9  7  7  9  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			compareensemblepp_cpdict_format_list = { 2  2  8  2  2  2  2  4  18  4  4  8  20  18  4  4  4  4  4  4  4  8  11  22  2  18  18  8  18  18  18  19  19  19  22  13  18  18  10  10  10 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 35 % CompareEnsemblePP_CpDict.TABLE_HEIGHT
					prop_settings = Format.getFormatSettings(22);
				case 36 % CompareEnsemblePP_CpDict.SELECTED
					prop_settings = Format.getFormatSettings(13);
				case 37 % CompareEnsemblePP_CpDict.TABLE
					prop_settings = Format.getFormatSettings(18);
				case 38 % CompareEnsemblePP_CpDict.CONTEXTMENU
					prop_settings = Format.getFormatSettings(18);
				case 39 % CompareEnsemblePP_CpDict.GUI_F_DICT
					prop_settings = 'GUIFig';
				case 40 % CompareEnsemblePP_CpDict.GUI_CP_DICT
					prop_settings = 'GUIElement';
				case 41 % CompareEnsemblePP_CpDict.GUI_BG_DICT
					prop_settings = 'GUIFig';
				case 3 % CompareEnsemblePP_CpDict.TEMPLATE
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 41 % CompareEnsemblePP_CpDict.GUI_BG_DICT
					prop_default = Format.getFormatDefault(10, CompareEnsemblePP_CpDict.getPropSettings(prop));
				case 1 % CompareEnsemblePP_CpDict.NAME
					prop_default = 'CompareEnsemblePP_CpDict';
				case 2 % CompareEnsemblePP_CpDict.DESCRIPTION
				...
				case 4 % CompareEnsemblePP_CpDict.ID
					prop_default = 'CompareEnsemblePP_CpDict';
				case 5 % CompareEnsemblePP_CpDict.LABEL
					prop_default = 'CompareEnsemblePP_CpDict label';
				case 6 % CompareEnsemblePP_CpDict.NOTES
					prop_default = 'CompareEnsemblePP_CpDict';
				case 22 % CompareEnsemblePP_CpDict.EL
					prop_default = CompareEnsemble();
				case 23 % CompareEnsemblePP_CpDict.PROP
					prop_default = 19;
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case 19 % CompareEnsemblePP_CpDict.X_DRAW
				...
				case 20 % CompareEnsemblePP_CpDict.UPDATE
				...
				case 21 % CompareEnsemblePP_CpDict.REDRAW
				...
				case 15 % CompareEnsemblePP_CpDict.SHOW
				...
				case 16 % CompareEnsemblePP_CpDict.HIDE
				...
				case 17 % CompareEnsemblePP_CpDict.DELETE
				...
				case 18 % CompareEnsemblePP_CpDict.CLOSE
