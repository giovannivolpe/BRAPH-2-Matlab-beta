		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PanelPropRVectorSmart.NAME
					prop_description = 'NAME (constant, string) is the name of the smart row vector panel.';
				case PanelPropRVectorSmart.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the smart row vectorpanel.';
				case PanelPropRVectorSmart.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the smart row vector panel.';
				case PanelPropRVectorSmart.ID
					prop_description = 'ID (data, string) is a few-letter code for the smart row vector panel.';
				case PanelPropRVectorSmart.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the smart row vector panel.';
				case PanelPropRVectorSmart.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the smart row vector panel.';
