		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case SettingsPositionPP.NAME
					prop_description = 'NAME (constant, string) is the name of the settings position panel.';
				case SettingsPositionPP.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the settings position panel.';
				case SettingsPositionPP.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the settings position panel.';
				case SettingsPositionPP.ID
					prop_description = 'ID (data, string) is a few-letter code for the settings position panel.';
				case SettingsPositionPP.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the settings position panel.';
				case SettingsPositionPP.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the settings position panel.';
