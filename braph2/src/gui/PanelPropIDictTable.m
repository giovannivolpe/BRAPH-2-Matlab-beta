classdef PanelPropIDictTable < PanelProp
	...
	methods % constructor
		function pr = PanelPropIDictTable(varargin)
			%PanelPropIDictTable() creates a panel property idict.
			%
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = PanelPropIDictTable.GETPROPS() returns the property list of panel property idict
			%  as a row vector.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = PanelPropIDictTable.GETPROPNUMBER() returns the property number of panel property idict.
			%
			% N = PanelPropIDictTable.GETPROPNUMBER(CATEGORY) returns the property number of panel property idict
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case PanelPropIDictTable.DESCRIPTION
					prop_default = 'PanelPropIDictTable plots the panel of an IDICT property with a table. It works for all categories. It can be personalized with the following props: COLS, ROWNAME, COLUMNNAME, COLUMNWIDTH, COLUMNEDITABLE, COLUMNFORMAT, CB_TAB_EDIT.';
				case PanelPropIDictTable.TEMPLATE
