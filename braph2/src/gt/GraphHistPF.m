classdef GraphHistPF < PanelFig
	...
	methods % constructor
		function pf = GraphHistPF(varargin)
			%GraphHistPF() creates a panel figure graph.
			%
	...
	methods (Static) % inspection
		...
		function prop_list = getProps(category)
			...
			%
			% PROPS = GraphHistPF.GETPROPS() returns the property list of panel figure graph
			%  as a row vector.
			%
		...
		function prop_number = getPropNumber(varargin)
			...
			%
			% N = GraphHistPF.GETPROPNUMBER() returns the property number of panel figure graph.
			%
			% N = GraphHistPF.GETPROPNUMBER(CATEGORY) returns the property number of panel figure graph
			%  of category CATEGORY
			%
			% Alternative forms to call this method are:
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case GraphHistPF.NAME
					prop_description = 'NAME (constant, string) is the name of the panel figure graph histogram.';
				case GraphHistPF.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the panel figure graph histogram.';
				case GraphHistPF.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the panel figure graph histogram.';
				case GraphHistPF.ID
					prop_description = 'ID (data, string) is a few-letter code for the panel figure graph histogram.';
				case GraphHistPF.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the panel figure graph histogram.';
				case GraphHistPF.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the panel figure graph histogram.';
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case GraphHistPF.DESCRIPTION
					prop_default = 'GraphHistPF manages the plot of the histogram of an adjaciency matrix.';
				case GraphHistPF.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, GraphHistPF.getPropSettings(prop));
				case GraphHistPF.ID
