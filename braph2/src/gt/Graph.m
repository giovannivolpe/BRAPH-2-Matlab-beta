classdef Graph < ConcreteElement
	...
	properties (Constant) % properties
		...
		MEASURE = ConcreteElement.getPropNumber() + 21;
		MEASURE_TAG = 'MEASURE';
		MEASURE_CATEGORY = Category.QUERY;
		MEASURE_FORMAT = Format.ITEM;
		
		PFGA = ConcreteElement.getPropNumber() + 22;
		PFGA_TAG = 'PFGA';
		PFGA_CATEGORY = Category.GUI;
		PFGA_FORMAT = Format.ITEM;
		
		PFGH = ConcreteElement.getPropNumber() + 23;
		PFGH_TAG = 'PFGH';
		PFGH_CATEGORY = Category.GUI;
		PFGH_FORMAT = Format.ITEM;
		
		SUBGRAPH = ConcreteElement.getPropNumber() + 24;
		SUBGRAPH_TAG = 'SUBGRAPH';
		SUBGRAPH_CATEGORY = Category.QUERY;
		SUBGRAPH_FORMAT = Format.ITEM;
	end
	methods % constructor
	...
	methods (Static) % inspection
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case Graph.SUBGRAPH
					prop_category = Graph.SUBGRAPH_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case Graph.SUBGRAPH
					prop_format = Graph.SUBGRAPH_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case Graph.SUBGRAPH
					prop_description = 'SUBGRAPH (query, item) is the subgraph';
				case Graph.NAME
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case Graph.NAME
					prop_default = 'Graph';
				case Graph.DESCRIPTION
					prop_default = 'Graph provides the methods necessary for all graphs. Instances of this class should not be created. Use one of its subclasses instead.';
				case Graph.ID
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case Graph.PFGH % __Graph.PFGH__
					check = Format.checkFormat(Format.ITEM, value, Graph.getPropSettings(prop));
				case Graph.SUBGRAPH % __Graph.SUBGRAPH__
					check = Format.checkFormat(Format.ITEM, value, Graph.getPropSettings(prop));
				otherwise
					if prop <= ConcreteElement.getPropNumber()
