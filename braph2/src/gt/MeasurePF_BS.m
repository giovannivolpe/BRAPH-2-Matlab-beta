		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case MeasurePF_BS.NAME
					prop_description = 'NAME (constant, string) is the name of the panel figure binodal superglobal measure.';
				case MeasurePF_BS.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the panel figure binodal superglobal measure.';
				case MeasurePF_BS.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the panel figure binodal superglobal measure.';
				case MeasurePF_BS.ID
					prop_description = 'ID (data, string) is a few-letter code for the panel figure binodal superglobal measure.';
				case MeasurePF_BS.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the panel figure binodal superglobal measure.';
				case MeasurePF_BS.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the panel figure binodal superglobal measure.';
