		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case MeasurePF_GU.NAME
					prop_description = 'NAME (constant, string) is the name of the panel figure global unilayer measure.';
				case MeasurePF_GU.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the panel figure global unilayer measure.';
				case MeasurePF_GU.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the panel figure global unilayer measure.';
				case MeasurePF_GU.ID
					prop_description = 'ID (data, string) is a few-letter code for the panel figure global unilayer measure.';
				case MeasurePF_GU.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the panel figure global unilayer measure.';
				case MeasurePF_GU.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the panel figure global unilayer measure.';
