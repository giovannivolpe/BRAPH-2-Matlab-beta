classdef MultiplexRCDeg < RCDeg
	...
	%  <strong>18</strong> <strong>MULTIRICHCLUB_COEFFICIENTS</strong> 	MULTIRICHCLUB_COEFFICIENTS (parameter, RVECTOR) is the multi rich-club degree coefficients
	%
	...
	properties (Constant) % properties
		MULTIRICHCLUB_COEFFICIENTS = 18; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'MULTIRICHCLUB_COEFFICIENTS' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'MULTIRICHCLUB_COEFFICIENTS' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				multiplexrcdeg_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'MULTIRICHCLUB_COEFFICIENTS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexrcdeg_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  9  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexrcdeg_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  8  11  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 18 % MultiplexRCDeg.MULTIRICHCLUB_COEFFICIENTS
