	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PathLengthOut.NAME
					prop_description = 'NAME (constant, string) is the name of the PathLengthOut.';
				case PathLengthOut.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the PathLengthOut.';
				case PathLengthOut.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the PathLengthOut.';
				case PathLengthOut.ID
					prop_description = 'ID (data, string) is a few-letter code of the PathLengthOut.';
				case PathLengthOut.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the PathLengthOut.';
				case PathLengthOut.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the PathLengthOut.';
				...
				case PathLengthOut.M
					prop_description = 'M (result, cell) is the cell containing the PathLengthOut.';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case PathLengthOut.LABEL
					prop_default = 'PathLengthOut label';
				case PathLengthOut.NOTES
					prop_default = 'PathLengthOut notes';
				case PathLengthOut.SHAPE
