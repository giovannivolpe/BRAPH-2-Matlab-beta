		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case EdgeBetwCentr.NAME
					prop_description = 'NAME (constant, string) is the name of the edgebetweennesscentrality.';
				case EdgeBetwCentr.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the edgebetweennesscentrality.';
				case EdgeBetwCentr.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the edgebetweennesscentrality.';
				case EdgeBetwCentr.ID
					prop_description = 'ID (data, string) is a few-letter code of the edgebetweennesscentrality.';
				case EdgeBetwCentr.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the edgebetweennesscentrality.';
				case EdgeBetwCentr.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the edgebetweennesscentrality.';
				...
				case EdgeBetwCentr.M
					prop_description = 'M (result, cell) is the edgebetweennesscentrality.';
				otherwise
