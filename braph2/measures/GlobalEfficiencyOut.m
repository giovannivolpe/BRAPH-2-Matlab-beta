	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case GlobalEfficiencyOut.NAME
					prop_description = 'NAME (constant, string) is the name of the GlobalEfficiencyOut.';
				case GlobalEfficiencyOut.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the GlobalEfficiencyOut.';
				case GlobalEfficiencyOut.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the GlobalEfficiencyOut.';
				case GlobalEfficiencyOut.ID
					prop_description = 'ID (data, string) is a few-letter code of the GlobalEfficiencyOut.';
				case GlobalEfficiencyOut.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the GlobalEfficiencyOut.';
				case GlobalEfficiencyOut.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the GlobalEfficiencyOut.';
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case GlobalEfficiencyOut.DESCRIPTION
					prop_default = 'The out-global efficiency is the average inverse shortest in-path length within each layer. It is inversely related to the characteristic in-path length.';
				case GlobalEfficiencyOut.TEMPLATE
