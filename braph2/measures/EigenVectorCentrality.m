		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case EigenVectorCentrality.NAME
					prop_description = 'NAME (constant, string) is the name of the eigenvectorcentrality.';
				case EigenVectorCentrality.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the eigenvectorcentrality.';
				case EigenVectorCentrality.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the eigenvectorcentrality.';
				case EigenVectorCentrality.ID
					prop_description = 'ID (data, string) is a few-letter code of the eigenvectorcentrality.';
				case EigenVectorCentrality.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the eigenvectorcentrality.';
				case EigenVectorCentrality.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the eigenvectorcentrality.';
				...
				case EigenVectorCentrality.M
					prop_description = 'M (result, cell) is the eigenvectorcentrality.';
				otherwise
