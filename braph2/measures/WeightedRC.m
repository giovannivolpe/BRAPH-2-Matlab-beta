classdef WeightedRC < Strength
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case WeightedRC.WRC_PARAMETER
						tag = WeightedRC.WRC_PARAMETER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case WeightedRC.WRC_PARAMETER
					prop_category = WeightedRC.WRC_PARAMETER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case WeightedRC.WRC_PARAMETER
					prop_format = WeightedRC.WRC_PARAMETER_FORMAT;
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case WeightedRC.WRC_PARAMETER % __WeightedRC.WRC_PARAMETER__
