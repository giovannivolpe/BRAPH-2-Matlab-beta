classdef MultiplexRCS < RCS
	...
	%  <strong>17</strong> <strong>PARAMETRIC_VALUE</strong> 	PARAMETRIC_VALUE (parameter, RVECTOR) 
	%  <strong>18</strong> <strong>WEIGHTED_MULTIRICHCLUB_COEFFICIENTS</strong> 	WEIGHTED_MULTIRICHCLUB_COEFFICIENTS (parameter, RVECTOR) is the multi rich-club strength coefficients
	%
	...
	properties (Constant) % properties
		WEIGHTED_MULTIRICHCLUB_COEFFICIENTS = 18; %CET: Computational Efficiency Trick
	...
	methods (Static) % inspection
		...
		function check_out = existsTag(tag)
			...
			check = any(strcmp(tag, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'WEIGHTED_MULTIRICHCLUB_COEFFICIENTS' })); %CET: Computational Efficiency Trick
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				prop = find(strcmp(pointer, { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'WEIGHTED_MULTIRICHCLUB_COEFFICIENTS' })); % tag = pointer %CET: Computational Efficiency Trick
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				multiplexrcs_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB'  'PARAMETRIC_VALUE'  'WEIGHTED_MULTIRICHCLUB_COEFFICIENTS' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexrcs_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  9  3  3 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexrcs_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  8  12  12 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 18 % MultiplexRCS.WEIGHTED_MULTIRICHCLUB_COEFFICIENTS
