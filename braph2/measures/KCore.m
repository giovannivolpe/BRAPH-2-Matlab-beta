	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case KCore.NAME
					prop_description = 'NAME (constant, string) is the name of the kcore.';
				case KCore.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the kcore.';
				case KCore.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the kcore.';
				case KCore.ID
					prop_description = 'ID (data, string) is a few-letter code of the kcore.';
				case KCore.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the kcore.';
				case KCore.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the kcore.';
				case KCore.SHAPE
				...
				case KCore.M
					prop_description = 'M (result, cell) is the kcore.';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case KCore.COMPATIBLE_GRAPHS
					prop_default = {'GraphBD' 'GraphBU' 'GraphWD' 'GraphWU' 'MultigraphBUD' 'MultigraphBUT' 'MultiplexBD' 'MultiplexBU' 'MultiplexWD' 'MultiplexWU' 'MultiplexBUD' 'MultiplexBUT' 'MultilayerBD' 'OrdMlWD'} ;%TBE % % % add tests for 'MultilayerWD' 'MultilayerBD';
				otherwise
