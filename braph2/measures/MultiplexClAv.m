classdef MultiplexClAv < MultiplexCl
	...
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the average multiplex clustering.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the average multiplex clustering.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the average multiplex clustering.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the average multiplex clustering.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the average multiplex clustering.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the average multiplex clustering.
	...
	%  <strong>14</strong> <strong>M</strong> 	M (result, cell) is the average multiplex clustering.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				multiplexclav_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexclav_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexclav_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  8 };
		...
		function prop_description = getPropDescription(pointer)
			...
			%CET: Computational Efficiency Trick
			multiplexclav_description_list = { 'ELCLASS (constant, string) is the class of the % % % .'  'NAME (constant, string) is the name of the average multiplex clustering.'  'DESCRIPTION (constant, string) is the description of the average multiplex clustering.'  'TEMPLATE (parameter, item) is the template of the average multiplex clustering.'  'ID (data, string) is a few-letter code of the average multiplex clustering.'  'LABEL (metadata, string) is an extended label of the average multiplex clustering.'  'NOTES (metadata, string) are some specific notes about the average multiplex clustering.'  'TOSTRING (query, string) returns a string that represents the object.'  'SHAPE (constant, scalar) is the measure shape Measure.NODAL.'  'SCOPE (constant, scalar) is the measure scope Measure.UNILAYER.'  'PARAMETRICITY (constant, scalar) is the parametricity of the measure Measure.NONPARAMETRIC.'  'COMPATIBLE_GRAPHS (constant, classlist) is the list of compatible graphs.'  'G (data, item) is the measure graph.'  'M (result, cell) is the average multiplex clustering.'  'PFM (gui, item) contains the panel figure of the measure.'  'PFB (gui, item) contains the panel figure of the brain measure.' };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % MultiplexClAv.ELCLASS
					prop_default = 'MultiplexClAv';
				case 2 % MultiplexClAv.NAME
					prop_default = 'MultiplexClusteringAv';
				case 3 % MultiplexClAv.DESCRIPTION
				...
				case 5 % MultiplexClAv.ID
					prop_default = 'MultiplexClAv ID';
				case 6 % MultiplexClAv.LABEL
					prop_default = 'MultiplexClusteringAv label';
				case 7 % MultiplexClAv.NOTES
					prop_default = 'MultiplexClusteringAv notes';
				case 9 % MultiplexClAv.SHAPE
					prop_default = 1;
				case 10 % MultiplexClAv.SCOPE
					prop_default = 1;
				case 11 % MultiplexClAv.PARAMETRICITY
					prop_default = 2;
				case 12 % MultiplexClAv.COMPATIBLE_GRAPHS
