	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				degreeav_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			degreeav_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  8 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 3 % DegreeAv.DESCRIPTION
					prop_default = 'The average degree of a graph is the average of all number of edges connected to a node within a layer. Connection weights are ignored in calculations.';
				case 4 % DegreeAv.TEMPLATE
					prop_default = Format.getFormatDefault(8, DegreeAv.getPropSettings(prop));
				case 5 % DegreeAv.ID
					prop_default = 'DegreeAv ID';
				case 6 % DegreeAv.LABEL
					prop_default = 'DegreeAv label';
				case 7 % DegreeAv.NOTES
					prop_default = 'DegreeAv notes';
