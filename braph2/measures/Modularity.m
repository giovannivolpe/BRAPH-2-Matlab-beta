classdef Modularity < CommunityStructure
	...
	%  <strong>1</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the modularity.
	%  <strong>2</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the modularity.
	%  <strong>3</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the modularity.
	...
	methods (Static) % inspection
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				case 1 % Modularity.NAME
					prop_default = 'Modularity';
				case 2 % Modularity.DESCRIPTION
				...
				case 4 % Modularity.ID
					prop_default = 'Modularity ID';
				case 5 % Modularity.LABEL
