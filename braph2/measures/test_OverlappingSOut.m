...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	m = OverlappingSOut( ...
		...
		OverlappingSOut.PFB, OverlappingSOut.getPropDefault(OverlappingSOut.PFB) ...
		);
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	m_1 = OverlappingSOut( ...
		...
		OverlappingSOut.PFB, m_0.getCallback(16) ... ...
		);
	...
	m_2 = OverlappingSOut( ...
		...
		OverlappingSOut.PFB, m_1.getCallback(16) ... ...
		);
	...
	m_3 = OverlappingSOut( ...
		...
		OverlappingSOut.PFB, m_2.getCallback(16) ... ...
		);
