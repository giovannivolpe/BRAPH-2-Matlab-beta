		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PathLengthIn.NAME
					prop_description = 'NAME (constant, string) is the name of the PathLengthIn.';
				case PathLengthIn.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the PathLengthIn.';
				case PathLengthIn.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the PathLengthIn.';
				case PathLengthIn.ID
					prop_description = 'ID (data, string) is a few-letter code of the PathLengthIn.';
				case PathLengthIn.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the PathLengthIn.';
				case PathLengthIn.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the PathLengthIn.';
				...
				case PathLengthIn.M
					prop_description = 'M (result, cell) is the cell containing the PathLengthIn.';
				otherwise
