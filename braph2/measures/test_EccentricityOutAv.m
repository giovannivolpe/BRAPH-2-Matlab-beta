...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	m = EccentricityOutAv( ...
		...
		EccentricityOutAv.PFB, EccentricityOutAv.getPropDefault(EccentricityOutAv.PFB), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	m_1 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PFB, m_0.getCallback(16), ..., ...
		EccentricityOutAv.RULE, m_0.getCallback(17) ... ...
		);
	...
	m_2 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PFB, m_1.getCallback(16), ..., ...
		EccentricityOutAv.RULE, m_1.getCallback(17) ... ...
		);
	...
	m_3 = EccentricityOutAv( ...
		...
		EccentricityOutAv.PFB, m_2.getCallback(16), ..., ...
		EccentricityOutAv.RULE, m_2.getCallback(17) ... ...
		);
