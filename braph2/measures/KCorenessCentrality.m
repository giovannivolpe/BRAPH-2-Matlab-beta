		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case KCorenessCentrality.NAME
					prop_description = 'NAME (constant, string) is the name of the kcorenesscentrality.';
				case KCorenessCentrality.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the kcorenesscentrality.';
				case KCorenessCentrality.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the kcorenesscentrality.';
				case KCorenessCentrality.ID
					prop_description = 'ID (data, string) is a few-letter code of the kcorenesscentrality.';
				case KCorenessCentrality.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the kcorenesscentrality.';
				case KCorenessCentrality.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the kcorenesscentrality.';
				...
				case KCorenessCentrality.M
					prop_description = 'M (result, cell) is the kcorenesscentrality.';
				otherwise
