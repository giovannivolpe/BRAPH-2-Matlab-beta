		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case EccentricityOut.NAME
					prop_description = 'NAME (constant, string) is the name of the eccentricityOut.';
				case EccentricityOut.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the eccentricityOut.';
				case EccentricityOut.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the eccentricityOut.';
				case EccentricityOut.ID
					prop_description = 'ID (data, string) is a few-letter code of the eccentricityOut.';
				case EccentricityOut.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the eccentricityOut.';
				case EccentricityOut.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the eccentricityOut.';
				...
				case EccentricityOut.M
					prop_description = 'M (result, cell) is the eccentricityOut.';
				otherwise
