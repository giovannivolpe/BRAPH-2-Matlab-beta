		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case PathLength.NAME
					prop_description = 'NAME (constant, string) is the name of the pathlength.';
				case PathLength.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the pathlength.';
				case PathLength.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the pathlength.';
				case PathLength.ID
					prop_description = 'ID (data, string) is a few-letter code of the pathlength.';
				case PathLength.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the pathlength.';
				case PathLength.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the pathlength.';
				...
				case PathLength.M
					prop_description = 'M (result, cell) is the cell containing the pathlength.';
				otherwise
