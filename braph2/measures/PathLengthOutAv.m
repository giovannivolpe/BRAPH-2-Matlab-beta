		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case PathLengthOutAv.NAME
					prop_description = 'NAME (constant, string) is the name of the PathLengthOutAv.';
				case PathLengthOutAv.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the PathLengthOutAv.';
				case PathLengthOutAv.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the PathLengthOutAv.';
				case PathLengthOutAv.ID
					prop_description = 'ID (data, string) is a few-letter code of the PathLengthOutAv.';
				case PathLengthOutAv.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the PathLengthOutAv.';
				case PathLengthOutAv.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the PathLengthOutAv.';
				...
				case PathLengthOutAv.M
					prop_description = 'M (result, cell) is the cell containing the PathLengthOutAv.';
				otherwise
