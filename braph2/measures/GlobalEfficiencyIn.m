		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case GlobalEfficiencyIn.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the GlobalEfficiencyIn.';
				case GlobalEfficiencyIn.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the GlobalEfficiencyIn.';
				case GlobalEfficiencyIn.ID
					prop_description = 'ID (data, string) is a few-letter code of the GlobalEfficiencyIn.';
				case GlobalEfficiencyIn.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the GlobalEfficiencyIn.';
				case GlobalEfficiencyIn.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the GlobalEfficiencyIn.';
