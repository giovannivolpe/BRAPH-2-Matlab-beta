classdef GlobalEfficiencyInAv < GlobalEfficiencyIn
	%GlobalEfficiencyInAv is the average graph in-global efficiency.
	...
	%  <strong>2</strong> <strong>NAME</strong> 	NAME (constant, string) is the name of the average in-global efficiency.
	%  <strong>3</strong> <strong>DESCRIPTION</strong> 	DESCRIPTION (constant, string) is the description of the average graph in-global efficiency.
	%  <strong>4</strong> <strong>TEMPLATE</strong> 	TEMPLATE (parameter, item) is the template of the average graph in-global efficiency.
	%  <strong>5</strong> <strong>ID</strong> 	ID (data, string) is a few-letter code of the average graph in-global efficiency.
	%  <strong>6</strong> <strong>LABEL</strong> 	LABEL (metadata, string) is an extended label of the average graph in-global efficiency.
	%  <strong>7</strong> <strong>NOTES</strong> 	NOTES (metadata, string) are some specific notes about the average graph in-global efficiency.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				globalefficiencyinav_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'PFB' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			globalefficiencyinav_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			globalefficiencyinav_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  8 };
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 3 % GlobalEfficiencyInAv.DESCRIPTION
					prop_default = 'The average in-global efficiency is the average inverse shortest in-path length within each layer.';
				case 4 % GlobalEfficiencyInAv.TEMPLATE
				...
				case 6 % GlobalEfficiencyInAv.LABEL
					prop_default = 'GlobalEfficiencyInAv label';
				case 7 % GlobalEfficiencyInAv.NOTES
					prop_default = 'GlobalEfficiencyInAv notes';
