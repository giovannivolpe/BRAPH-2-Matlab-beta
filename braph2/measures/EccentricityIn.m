		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case EccentricityIn.NAME
					prop_description = 'NAME (constant, string) is the name of the eccentricityIn.';
				case EccentricityIn.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the eccentricityIn.';
				case EccentricityIn.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the eccentricityIn.';
				case EccentricityIn.ID
					prop_description = 'ID (data, string) is a few-letter code of the eccentricityIn.';
				case EccentricityIn.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the eccentricityIn.';
				case EccentricityIn.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the eccentricityIn.';
				...
				case EccentricityIn.M
					prop_description = 'M (result, cell) is the eccentricityIn.';
				otherwise
