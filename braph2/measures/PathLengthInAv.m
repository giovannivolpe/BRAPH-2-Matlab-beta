		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case PathLengthInAv.NAME
					prop_description = 'NAME (constant, string) is the name of the PathLengthInAv.';
				case PathLengthInAv.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the PathLengthInAv.';
				case PathLengthInAv.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the PathLengthInAv.';
				case PathLengthInAv.ID
					prop_description = 'ID (data, string) is a few-letter code of the PathLengthInAv.';
				case PathLengthInAv.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the PathLengthInAv.';
				case PathLengthInAv.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the PathLengthInAv.';
				...
				case PathLengthInAv.M
					prop_description = 'M (result, cell) is the cell containing the PathLengthInAv.';
				otherwise
