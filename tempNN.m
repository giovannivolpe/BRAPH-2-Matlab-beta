...
%% pipelines
el_class_list = {'NNDataPoint_CON_FUN_MP_REG'}; % 'NNDataPoint_CON_CLA' 'NNDataPoint_CON_REG' 'NNDataPoint_CON_CLA'
for i = 1:1:length(el_class_list)
    el_class = el_class_list{i};
    el_path = '/pipelines/connectivity-functional multiplex NN'; % '/pipelines/connectivity NN' 
