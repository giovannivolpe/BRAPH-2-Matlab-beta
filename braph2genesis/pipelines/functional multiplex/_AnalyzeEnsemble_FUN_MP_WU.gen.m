...
%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.ID
%%%% ¡title!
Analysis ID

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.LABEL
%%%% ¡title!
Analysis NAME

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.GR
%%%% ¡title!
SUBJECT GROUP

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.GRAPH_TEMPLATE
%%%% ¡title!
...
%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.ME_DICT
%%%% ¡title!
Group-averaged MEASURES

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.G_DICT
%%%% ¡title!
Individual GRAPHS

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_FUN_MP_WU.NOTES
%%%% ¡title!
Analysis NOTES
...
%%% ¡prop!
DESCRIPTION (constant, string) is the description of the ensemble-based graph analysis with functional multiplex data.
%%%% ¡default!
'This graph analysis (AnalyzeEnsemble_FUN_MP_WU) analyzes functional multiplex data using weighted undirected graphs.'

%%% ¡prop!
TEMPLATE (parameter, item) is the template of the ensemble-based graph analysis with functional multiplex data.
%%%% ¡settings!
'AnalyzeEnsemble_FUN_MP_WU'

%%% ¡prop!
ID (data, string) is a few-letter code for the ensemble-based graph analysis with functional multiplex data.
%%%% ¡default!
'AnalyzeEnsemble_FUN_MP_WU ID'

%%% ¡prop!
LABEL (metadata, string) is an extended label of the ensemble-based graph analysis with functional multiplex data.
%%%% ¡default!
'AnalyzeEnsemble_FUN_MP_WU label'

%%% ¡prop!
NOTES (metadata, string) are some specific notes about the ensemble-based graph analysis with functional multiplex data.
%%%% ¡default!
'AnalyzeEnsemble_FUN_MP_WU notes'
...
%%% ¡excluded_props!
[AnalyzeEnsemble_FUN_MP_WU.TEMPLATE AnalyzeEnsemble_FUN_MP_WU.GRAPH_TEMPLATE]
...
a = AnalyzeEnsemble_FUN_MP_WU('GR', gr);
...
a1 = AnalyzeEnsemble_FUN_MP_WU('GR', gr1);
a2 = AnalyzeEnsemble_FUN_MP_WU('GR', gr2, 'TEMPLATE', a1);
