%% ¡header!
NNDataPoint_CON_MEASURE_CLA < NNDataPoint_CON_CLA (dp, connectivity classification data point) is a data point for classification with connectivity data.
