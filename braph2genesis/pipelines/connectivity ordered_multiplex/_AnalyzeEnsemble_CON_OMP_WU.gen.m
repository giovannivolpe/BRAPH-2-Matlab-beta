...
%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_CON_OMP_WU.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_CON_OMP_WU.GR
%%%% ¡title!
SUBJECT GROUP

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_CON_OMP_WU.GRAPH_TEMPLATE
%%%% ¡title!
GRAPH & MEASURE PARAMETERS

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_CON_OMP_WU.ME_DICT
%%%% ¡title!
Group-averaged MEASURES

%%% ¡prop!
%%%% ¡id!
AnalyzeEnsemble_CON_OMP_WU.G_DICT
%%%% ¡title!
Individual GRAPHS
...
%%% ¡excluded_props!
[AnalyzeEnsemble_CON_OMP_WU.TEMPLATE AnalyzeEnsemble_CON_OMP_WU.GRAPH_TEMPLATE]
...
a = AnalyzeEnsemble_CON_OMP_WU('GR', gr);
...
a1 = AnalyzeEnsemble_CON_OMP_WU('GR', gr1);
a2 = AnalyzeEnsemble_CON_OMP_WU('GR', gr2, 'TEMPLATE', a1);
