...
im_gr1 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST_MM XLS' filesep 'ST_MM_Group1_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
...
im_gr2 = ImporterGroupSubjectST_MP_XLS( ...
    'DIRECTORY', [fileparts(which('NNDataPoint_ST_MM_CLA')) filesep 'Example data NN CLA ST_MM XLS' filesep 'ST_MM_Group2_XLS'], ...
    'BA', ba, ...
    'WAITBAR', true ...
    );
