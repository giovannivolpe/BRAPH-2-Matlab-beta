%% ¡header!
MultiplexClustr < MultiplexTri (m, weighted clustering) is the graph weighted multiplex clustering.
...
%%% ¡prop!
%%%% ¡id!
MultiplexClustr.NOTES
%%%% ¡title!
Measure NOTES

%%% ¡prop!
%%%% ¡id!
MultiplexClustr.COMPATIBLE_GRAPHS
%%%% ¡title!
Compatible Graphs
