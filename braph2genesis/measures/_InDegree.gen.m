...
%%%% ¡default!
'The in-degree of a node is the number of inward edges connected to a node within a layer. Connection weights are ignored in calculations.'
...
assert(isequal(m_outside_g.get('M'), known_in_degree), ...
   [BRAPH2.STR ':InDegree:' BRAPH2.FAIL_TEST], ...
    [class(m_outside_g) ' is not being calculated correctly for ' class(g) '.'])

m_inside_g = g.get('Measure', 'InDegree');
