%% ¡header!
MultiplexKCCentrality < Measure (m, multiplex k-coreness centrality) is the graph multiplex k-coreness centrality.
...
%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.ID
%%%% ¡title!
Measure ID

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.LABEL
%%%% ¡title!
Measure NAME

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.G
%%%% ¡title!
Graph

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.M
%%%% ¡title!
MultiplexKCCentrality

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.PFM
%%%% ¡title!
Measure Plot

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.NOTES
%%%% ¡title!
Measure NOTES

%%% ¡prop!
%%%% ¡id!
MultiplexKCCentrality.COMPATIBLE_GRAPHS
%%%% ¡title!
Compatible Graphs
