                ...
                case Measure.GLOBAL % __Measure.GLOBAL__
                    switch m.get('SCOPE')
                        case Measure.SUPERGLOBAL % __Measure.SUPERGLOBAL__
                            mGBPF = MeasureEnsembleBrainPF_GS('M', m, 'BA', brain_atlas); %%%%%%%%%%%%%%%%%%
                        case Measure.UNILAYER % __Measure.UNILAYER__
                            mGBPF = MeasureEnsembleBrainPF_GU('M', m, 'BA', brain_atlas);
                        case Measure.BILAYER % __Measure.BILAYER__
                            mGBPF = MeasureEnsembleBrainPF_GB('M', m, 'BA', brain_atlas);
                    end
                case Measure.NODAL % __Measure.NODAL__
                    switch m.get('SCOPE')
                        case Measure.SUPERGLOBAL % __Measure.SUPERGLOBAL__
                            mGBPF = MeasureEnsembleBrainPF_NS('M', m, 'BA', brain_atlas);
                        case Measure.UNILAYER % __Measure.UNILAYER__
                            mGBPF = MeasureEnsembleBrainPF_NU('M', m, 'BA', brain_atlas);
                        case Measure.BILAYER % __Measure.BILAYER__
                            mGBPF = MeasureEnsembleBrainPF_NB('M', m, 'BA', brain_atlas);
                    end
                case Measure.BINODAL % __Measure.BINODAL__
                    switch m.get('SCOPE')
                        case Measure.SUPERGLOBAL % __Measure.SUPERGLOBAL__
                            mGBPF = MeasureEnsembleBrainPF_BS('M', m, 'BA', brain_atlas);
                        case Measure.UNILAYER % __Measure.UNILAYER__
                            mGBPF = MeasureEnsembleBrainPF_BU('M', m, 'BA', brain_atlas);
                        case Measure.BILAYER % __Measure.BILAYER__
                            mGBPF =  MeasureEnsembleBrainPF_BB('M', m, 'BA', brain_atlas);
                    end
            end
