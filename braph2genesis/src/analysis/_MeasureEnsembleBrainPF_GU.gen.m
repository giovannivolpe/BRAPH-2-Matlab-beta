...
'SettingsArea'
%%%% ¡gui!
pr = SettingsAreaPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_AREA, varargin{:});
...
'SettingsLine'
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_LINE_DIFF, varargin{:});
...
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_LINE_CIL, varargin{:});
...
SettingsLine('SYMBOLSIZE', 6, 'FACECOLOR', [.5 .5 .5])
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_LINE_CIU, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_TITLE, varargin{:});
...
SettingsText('VISIBLE', true, 'FONTSIZE', s(2), 'HALIGN', 'center', 'VALIGN', 'middle')
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_XLABEL, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_GU.ST_YLABEL, varargin{:});
