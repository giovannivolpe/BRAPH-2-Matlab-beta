...
%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_LINE_DIFF
%%%% ¡title!
DIFFERENCE

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_AREA
%%%% ¡title!
CONFIDENCE AREA (95%)

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_LINE_CIL
%%%% ¡title!
LOWER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_LINE_CIU
%%%% ¡title!
UPPER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_TITLE
%%%% ¡title!
TITLE

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_XLABEL
%%%% ¡title!
X-LABEL

%%% ¡prop!
%%%% ¡id!
ComparisonGroupBrainPF_BB.ST_YLABEL
%%%% ¡title!
Y-LABEL
...
%%% ¡excluded_props!
[ComparisonGroupBrainPF_BB.PARENT ComparisonGroupBrainPF_BB.H ComparisonGroupBrainPF_BB.ST_POSITION ComparisonGroupBrainPF_BB.ST_AXIS ComparisonGroupBrainPF_BB.ST_AREA ComparisonGroupBrainPF_BB.ST_LINE_DIFF ComparisonGroupBrainPF_BB.ST_LINE_CIL ComparisonGroupBrainPF_BB.ST_LINE_CIU ComparisonGroupBrainPF_BB.ST_TITLE ComparisonGroupBrainPF_BB.ST_XLABEL ComparisonGroupBrainPF_BB.ST_YLABEL] 
