%% ¡header!
ComparisonEnsemblePF < PanelFig (pf, panel group comparison figure) is the base element to plot a group comparison.

%%% ¡description!
ComparisonEnsemblePF manages the basic functionalities to plot of a group comparison.
...
%%% ¡prop!
%%%% ¡id!
ComparisonEnsemblePF.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
ComparisonEnsemblePF.ST_POSITION
%%%% ¡title!
PANEL POSITION
...
%%% ¡excluded_props!
[ComparisonEnsemblePF.PARENT ComparisonEnsemblePF.H ComparisonEnsemblePF.ST_POSITION ComparisonEnsemblePF.ST_AXIS ComparisonEnsemblePF.ST_AREA ComparisonEnsemblePF.ST_LINE_DIFF ComparisonEnsemblePF.ST_LINE_CIL ComparisonEnsemblePF.ST_LINE_CIU ComparisonEnsemblePF.ST_TITLE ComparisonEnsemblePF.ST_XLABEL ComparisonEnsemblePF.ST_YLABEL] 
