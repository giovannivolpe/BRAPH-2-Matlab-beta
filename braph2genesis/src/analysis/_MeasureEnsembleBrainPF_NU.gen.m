...
if value
    ...
    pf.memorize('ST_AXIS').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_AXES).get('SETUP')
    pf.memorize('LISTENER_ST_AXIS');

    pf.memorize('H_AREA')
    pf.memorize('ST_AREA').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_AREA).get('SETUP')
    pf.memorize('LISTENER_ST_AREA');

    pf.memorize('H_LINE_DIFF')
    pf.memorize('ST_LINE_DIFF').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_LINE_DIFF).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_DIFF');

    pf.memorize('H_LINE_CIL')
    pf.memorize('ST_LINE_CIL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_LINE_CIL).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_CIL');

    pf.memorize('H_LINE_CIU')
    pf.memorize('ST_LINE_CIU').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_LINE_CIU).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_CIU');

    pf.memorize('H_TITLE')
    pf.memorize('ST_TITLE').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_TITLE).get('SETUP')

    pf.memorize('H_XLABEL')
    pf.memorize('ST_XLABEL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_XLABEL).get('SETUP')

    pf.memorize('H_YLABEL')
    pf.memorize('ST_YLABEL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_NU.H_YLABEL).get('SETUP')
...
%%%% ¡gui!
pr = SettingsAxisPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_AXIS, varargin{:});
...
'SettingsArea'
%%%% ¡gui!
pr = SettingsAreaPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_AREA, varargin{:});
...
'SettingsLine'
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_LINE_DIFF, varargin{:});
...
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_LINE_CIL, varargin{:});
...
SettingsLine('SYMBOLSIZE', 6, 'FACECOLOR', [.5 .5 .5])
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_LINE_CIU, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_TITLE, varargin{:});
...
SettingsText('VISIBLE', true, 'FONTSIZE', s(2), 'HALIGN', 'center', 'VALIGN', 'middle')
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_XLABEL, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_NU.ST_YLABEL, varargin{:});

%% ¡tests!

%%% ¡excluded_props!
[MeasureEnsembleBrainPF_NU.PARENT MeasureEnsembleBrainPF_NU.H MeasureEnsembleBrainPF_NU.ST_POSITION MeasureEnsembleBrainPF_NU.ST_AXIS MeasureEnsembleBrainPF_NU.ST_AREA MeasureEnsembleBrainPF_NU.ST_LINE_DIFF MeasureEnsembleBrainPF_NU.ST_LINE_CIL MeasureEnsembleBrainPF_NU.ST_LINE_CIU MeasureEnsembleBrainPF_NU.ST_TITLE MeasureEnsembleBrainPF_NU.ST_XLABEL MeasureEnsembleBrainPF_NU.ST_YLABEL] 
