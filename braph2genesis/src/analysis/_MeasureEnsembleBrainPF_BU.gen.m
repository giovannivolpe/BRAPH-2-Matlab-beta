%% ¡header!
MeasureEnsembleBrainPF_BU  < MeasureEnsembleBrainPF (pf, brain panel group comparison on brain surface figure) is the base element to plot a group comparison on brain surface.

%%% ¡description!
MeasureEnsembleBrainPF_BU manages the basic functionalities to plot of a group comparison on brain surface.
...
%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.WAITBAR
%%%% ¡title!
WAITBAR ON/OFF
...
%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.BKGCOLOR
%%%% ¡title!
BACKGROUND COLOR

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_POSITION
%%%% ¡title!
PANEL POSITION

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_AXIS
%%%% ¡title!
AXIS

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_LINE_DIFF
%%%% ¡title!
DIFFERENCE

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_AREA
%%%% ¡title!
CONFIDENCE AREA (95%)

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_LINE_CIL
%%%% ¡title!
LOWER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_LINE_CIU
%%%% ¡title!
UPPER CONFIDENCE LINE

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_TITLE
%%%% ¡title!
TITLE

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_XLABEL
%%%% ¡title!
X-LABEL

%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.ST_YLABEL
%%%% ¡title!
Y-LABEL
...
if value
    ...
    pf.memorize('ST_AXIS').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_AXES).get('SETUP')
    pf.memorize('LISTENER_ST_AXIS');

    pf.memorize('H_AREA')
    pf.memorize('ST_AREA').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_AREA).get('SETUP')
    pf.memorize('LISTENER_ST_AREA');

    pf.memorize('H_LINE_DIFF')
    pf.memorize('ST_LINE_DIFF').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_LINE_DIFF).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_DIFF');

    pf.memorize('H_LINE_CIL')
    pf.memorize('ST_LINE_CIL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_LINE_CIL).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_CIL');

    pf.memorize('H_LINE_CIU')
    pf.memorize('ST_LINE_CIU').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_LINE_CIU).get('SETUP')
	pf.memorize('LISTENER_ST_LINE_CIU');

    pf.memorize('H_TITLE')
    pf.memorize('ST_TITLE').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_TITLE).get('SETUP')

    pf.memorize('H_XLABEL')
    pf.memorize('ST_XLABEL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_XLABEL).get('SETUP')

    pf.memorize('H_YLABEL')
    pf.memorize('ST_YLABEL').set('PANEL', pf, 'PROP', MeasureEnsembleBrainPF_BU.H_YLABEL).get('SETUP')
...
%%%% ¡gui!
pr = SettingsAxisPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_AXIS, varargin{:});
...
'SettingsArea'
%%%% ¡gui!
pr = SettingsAreaPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_AREA, varargin{:});
...
'SettingsLine'
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_LINE_DIFF, varargin{:});
...
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_LINE_CIL, varargin{:});
...
SettingsLine('SYMBOLSIZE', 6, 'FACECOLOR', [.5 .5 .5])
%%%% ¡gui!
pr = SettingsLinePP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_LINE_CIU, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_TITLE, varargin{:});
...
SettingsText('VISIBLE', true, 'FONTSIZE', s(2), 'HALIGN', 'center', 'VALIGN', 'middle')
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_XLABEL, varargin{:});
...
%%%% ¡gui!
pr = SettingsTextPP('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.ST_YLABEL, varargin{:});

%% ¡tests!

%%% ¡excluded_props!
[MeasureEnsembleBrainPF_BU.PARENT MeasureEnsembleBrainPF_BU.H MeasureEnsembleBrainPF_BU.ST_POSITION MeasureEnsembleBrainPF_BU.ST_AXIS MeasureEnsembleBrainPF_BU.ST_AREA MeasureEnsembleBrainPF_BU.ST_LINE_DIFF MeasureEnsembleBrainPF_BU.ST_LINE_CIL MeasureEnsembleBrainPF_BU.ST_LINE_CIU MeasureEnsembleBrainPF_BU.ST_TITLE MeasureEnsembleBrainPF_BU.ST_XLABEL MeasureEnsembleBrainPF_BU.ST_YLABEL] 
