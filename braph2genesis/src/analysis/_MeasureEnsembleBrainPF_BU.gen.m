...
%%% ¡prop!
%%%% ¡id!
MeasureEnsembleBrainPF_BU.NODES
%%%% ¡title!
NODES SELECTION
...
%%%% ¡default!
'MeasureEnsembleBrainPF_BU manages the basic functionalities to plot of a binodal unilayer group comparison on brain surface figure.'
...
pf.get('SETUP')
%%%% ¡gui!
pr = ComparisonGroupPF_BxPP_Node('EL', pf, 'PROP', MeasureEnsembleBrainPF_BU.NODES);

%% ¡tests!

%%% ¡excluded_props!
[MeasureEnsembleBrainPF_BU.PARENT MeasureEnsembleBrainPF_BU.H MeasureEnsembleBrainPF_BU.ST_POSITION MeasureEnsembleBrainPF_BU.ST_AXIS MeasureEnsembleBrainPF_BU.CP MeasureEnsembleBrainPF_BU.ST_AREA MeasureEnsembleBrainPF_BU.ST_LINE_DIFF MeasureEnsembleBrainPF_BU.ST_LINE_CIL MeasureEnsembleBrainPF_BU.ST_LINE_CIU MeasureEnsembleBrainPF_BU.ST_TITLE MeasureEnsembleBrainPF_BU.ST_XLABEL MeasureEnsembleBrainPF_BU.ST_YLABEL] 
