...
\fig{figure}
	...
	{\bf c}-{\bf f} navigate to the BRAPH~2.0 folder \fn{pipelines}, {\bf d} \fn{structural},  {\bf e} \fn{Example data ST XLS}, and {\bf f} select the structural values of one group \fn{ST\_Group\_1\_XLSX}.
	}
...
Moreover, if you don't have the \fn{Example data ST XLS} folder inside \fn{structural}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
