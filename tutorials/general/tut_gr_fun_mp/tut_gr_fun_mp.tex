...
\fig{figure}
	...
	{\bf c}-{\bf f} navigate to the BRAPH~2.0 folder \fn{pipelines}, {\bf d} \fn{functional multiplex},  {\bf e} \fn{Example data FUN\_MP XLS}, and {\bf f} select the folder with functional multiplex values of one group \fn{FUN\_MP\_Group\_1\_XLS}.
	}
...
Moreover, if you don't have the \fn{Example data FUN\_MP XLS} folder inside \fn{functional multiplex}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
