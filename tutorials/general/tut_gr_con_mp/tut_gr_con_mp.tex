...
Moreover, if you don't have the \fn{Example data CON\_MP XLS} folder inside \fn{connectivity multiplex}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
