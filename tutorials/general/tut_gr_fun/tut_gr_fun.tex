...
In most analyses, the group GUI is the second step after you have selected a brain atlas. You can open it by typing \code{braph2} in MatLab's terminal, which allows you to select a pipeline containing the steps required to perform your analysis and upload a brain atlas. After these steps have been completed you can upload your group's data directly (\Figref{fig:02}c-f) after clicking ``Load Group''. You can also open the GUI and upload the brain functional data using the command line (i.e., without opening an analysis pipeline) by typing the commands in \Coderef{cd:launch}. In that case, you can upload the data as shown in \Figref{fig:02}a-f.
...
Moreover, if you don't have the \fn{Example data FUN XLS} folder inside \fn{functional}, then you can generate it by running the commands in \Coderef{cd:exampledata}.
