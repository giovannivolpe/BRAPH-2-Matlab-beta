...
In this Tutorial, we will explain how to create the generator file \fn{*.gen.m} for a new property panel which can the be compiled by \code{braph2genesis}, using the property panel \code{PanelPropLogical} as an example.
\end{abstract}
